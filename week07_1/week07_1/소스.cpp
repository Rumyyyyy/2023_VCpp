...
int main() {
    ...
    // 윈도우를 생성합니다.
    HWND hwnd = CreateWindow(L"MyWindowClass", L"My Window", WS_OVERLAPPEDWINDOW, 100, 100, 800, 600, NULL, NULL, GetModuleHandle(NULL), NULL);
    ...
    // 버튼 3을 생성합니다.
    CreateWindow(L"BUTTON", L"Button 3", WS_CHILD | WS_VISIBLE, 350, 50, 100, 30, hwnd, (HMENU)3, GetModuleHandle(NULL), NULL);
